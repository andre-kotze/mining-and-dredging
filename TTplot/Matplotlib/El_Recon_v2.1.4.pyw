...
class El_Recon_Dos(QWidget):
    ...
    def files(self):
        ...
        self.open_sl_btn.clicked.connect(lambda: os.system(self.act_sl))
        ...
        self.open_drs_btn.clicked.connect(lambda: os.system(self.act_drs))
        ...
        self.open_sr_btn.clicked.connect(lambda: os.system(self.act_sr))
    ...
    def change_sl(self):
        ...
        if len(file) != 0 and file != self.act_sl:
            ...
            save_cfg('last_used', 'sl', self.act_sl)
    ...
    def change_drs(self):
        ...
        if len(file) != 0 and file != self.act_drs:
            ...
            self.readsl_btn.setText('Load')
            self.readsl_btn.setEnabled(True)
            save_cfg('last_used', 'drs', self.act_drs)
    ...
    def change_sr(self):
        ...
        if len(file) != 0 and file != self.act_sr:
            ...
            save_cfg('last_used', 'sr', self.act_sr)
    ...
    def recon_drs_sl(self):
        ...
        save_cfg('last_used', 'start', dates[0])
        save_cfg('last_used', 'end', dates[1])
        ...
        if external_report(content):
            ...
            save_cfg('stats', 'reports', str(self.report_nr))
            save_cfg('stats', 'mistakes', str(self.gt_mistakes))
        else:
