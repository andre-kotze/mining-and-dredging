...
class Reader(QObject):
    ...
    def __init__(self, readargs, parent=None):
        super().__init__(parent)
        # readargs = [filename, columns, dtbool, endat ]
    def readfile(self):
        print("Reading Screenlog")

        pd.read_excel('C:/Users/User/Desktop/SHARE/3. SAMICOR/ML103A/Screenlog_Samicor_ML103A.XLSB', engine='pyxlsb')
        self.done.emit(True)
        print("done")
...
class QuasarExport(QWidget): #TableWidget
    ...
    def initQE(self):
        ...
        #self.readbtn = QPushButton('"READ"') # TEMP
        #self.readbtn.clicked.connect(loaderDialog) # TEMP
